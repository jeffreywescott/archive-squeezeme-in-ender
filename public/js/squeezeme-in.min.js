...
/*!
    ...
    * License: MIT
    */
(function(t,n,r){typeof e!="undefined"&&e.exports?e.exports=r():typeof define=="function"&&define.amd?define(r):n[t]=r()})("$script",this,function(){function v(e,t){for(var n=0,r=e.length;n<r;++n)if(!t(e[n]))return f;return 1}function m(e,t){v(e,function(e){return!t(e)})}function g(e,t,a){function d(e){return e.call?e():r[e]}function b(){if(!--p){r[h]=1,c&&c();for(var e in s)v(e.split("|"),d)&&!m(s[e],d)&&(s[e]=[])}}e=e[l]?e:[e];var f=t&&t.call,c=f?t:a,h=f?e.join(""):t,p=e.length;return setTimeout(function(){m(e,function(e){if(e===null)return b();if(u[e])return h&&(i[h]=1),u[e]==2&&b();u[e]=1,h&&(i[h]=1),y(!n.test(e)&&o?o+e+".js":e,b)})},0),g}function y(n,r){var i=e.createElement("script"),s=f;i.onload=i.onerror=i[d]=function(){if(i[h]&&!/^c|loade/.test(i[h])||s)return;i.onload=i[d]=null,s=1,u[n]=2,r()},i.async=1,i.src=n,t.insertBefore(i,t.firstChild)}var e=document,t=e.getElementsByTagName("head")[0],n=/^https?:\/\//,r={},i={},s={},o,u={},a="string",f=!1,l="push",c="DOMContentLoaded",h="readyState",p="addEventListener",d="onreadystatechange";return!e[h]&&e[p]&&(e[p](c,function b(){e.removeEventListener(c,b,f),e[h]="complete"},f),e[h]="loading"),g.get=y,g.order=function(e,t,n){(function r(i){i=e.shift(),e.length?g(i,r):g(i,t,n)})()},g.path=function(e){o=e},g.ready=function(e,t,n){e=e[l]?e:[e];var i=[];return!m(e,function(e){r[e]||i[l](e)})&&v(e,function(e){return r[e]})?t():!function(e){s[e]=s[e]||[],s[e][l](t),n&&n(i)}(e.join("|")),g},g.done=function(e){g([null],e)},g}),typeof provide=="function"&&provide("scriptjs",e.exports);var n=require("scriptjs");ender.ender({script:n,require:n,ready:n.ready,getScript:n.get})}(),function(){var e={exports:{}},t=e.exports;$.require(["//ajax.googleapis.com/ajax/libs/jquery/2.0.0/jquery.min.js","//ajax.googleapis.com/ajax/libs/jqueryui/1.10.3/jquery-ui.min.js"],function(){$("head").append("<link rel='stylesheet' type='text/css' href='http://fonts.googleapis.com/css?family=Open+Sans:300,400,600,700,800'>"),$("head").append("<link rel='stylesheet' type='text/css' href='//cdnjs.cloudflare.com/ajax/libs/fullcalendar/1.6.1/fullcalendar.css'>"),$("head").append("<link rel='stylesheet' type='text/css' href='//cdnjs.cloudflare.com/ajax/libs/fullcalendar/1.6.1/fullcalendar.print.css' media='print'>"),$.getScript("//cdnjs.cloudflare.com/ajax/libs/fullcalendar/1.6.1/fullcalendar.min.js",function(){var e=new Date,t=e.getDate(),n=e.getMonth(),r=e.getFullYear(),i=$("#calendar").fullCalendar({header:{left:"prev,next today",center:"title",right:"agendaWeek,agendaDay"},theme:!1,availableViews:"agendaWeek,agendaDay",defaultView:"agendaWeek",firstDay:1,weekends:!0,defaultEventMinutes:60,allDaySlot:!1,minTime:6,maxTime:23,firstHour:8,slotMinutes:30,selectable:!0,selectHelper:!0,select:function(e,t,n){var r="Your Appointment";i.fullCalendar("renderEvent",{title:r,start:e,end:t,allDay:n,editable:!0},!0),i.fullCalendar("unselect")},editable:!1})})}),typeof provide=="function"&&provide("squeezeme-in-widget",e.exports),$.ender(e.exports)}()